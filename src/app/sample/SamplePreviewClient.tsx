...
export default function SamplePreviewClient({ recruiting, active, inquiryUrl }: Props) {
  ...
  return (
    <div className="pb-16 pt-8 md:pt-10">
      ...
      <div className="mt-10 border-y border-[var(--line)] bg-[#f4f7fb] py-3">
      ...
      <article className="container max-w-3xl py-10">
        <div className="mb-8 overflow-hidden rounded-[1.75rem] border border-[var(--line)]">
          <Image
        ...
        <div className="mt-10 rounded-[1.75rem] border border-dashed border-[var(--line)] bg-white p-6">
      ...
      <div className="container max-w-3xl">
        <aside className="rounded-[1.75rem] border border-[var(--sky)] bg-[var(--sky-soft)] p-6 text-center md:p-8">
